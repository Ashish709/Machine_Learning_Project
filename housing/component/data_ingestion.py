...
class DataIngestion:
    ...
    def spit_data_as_train_test(self):
        try:
            raw_data_dir = self.data_ingestion_config.raw_data_dir
            ...
            spit = StratifiedShuffleSplit(n_splits = 1,
                                        test_size = 0.2,
                                        random_state = 42)
            
            for train_index,test_index in spit.split(housing_data_frame,
            ...
            if strat_test_set is not None:
                ...
                logging.info(f"Exporting test datset to file: [{test_file_path}]")
    ...
    def initiated_data_ingestion(self) -> DataIngestionArtifact:
        try:
            ...
            return self.spit_data_as_train_test()
