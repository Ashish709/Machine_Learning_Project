...
ModelTrainerConfig, ModelEvaluationConfig, ModelPushserConfig, TrainingPipelineConfig

from housing.exception import HousingException
from housing.logger import logging
from housing.util.utils import read_yaml_file
...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            preprocessed_file_path = os.path.join(data_transformation_artifact_dir,
    ...
    def get_model_pusher_config(self) -> ModelPushserConfig:
        pass
